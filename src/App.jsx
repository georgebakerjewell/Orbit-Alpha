          ...
          <div style={{animation:"fu 0.3s ease",maxWidth:800,margin:"0 auto",padding:"32px 20px 60px"}}>
            ...
            {feedMode==="newsletter"&&(
              <div style={{animation:"fu 0.2s ease"}}>
                ...
                {[
                  {issue:14,date:'26 July 2026',headline:'The index funds bought. Everyone else sold.',summary:'Starship flew. The stock didn't care.',url:LATEST_ISSUE_URL,live:latestIssueLive},  
