...
// Issue #9 is now published, so keep this live.
// This can point to the Issue #9 URL even if Beehiiv temporarily shows 404 before the page is fully live.
const latestIssueLive = true;
const LATEST_ISSUE_URL = "https://orbit-alpha.beehiiv.com/p/orbit-alpha-issue-9";
        ...
        {page==="home"&&(
          <div onClick={()=>latestIssueLive&&window.open(LATEST_ISSUE_URL,"_blank")} style={{background:"rgba(126,184,255,0.06)",borderBottom:"1px solid rgba(126,184,255,0.12)",padding:"8px 20px",textAlign:"center",cursor:latestIssueLive?"pointer":"default",transition:"background 0.2s"}}
            ...
            <span style={{fontSize:11,color:"#7eb8ff",letterSpacing:"0.04em"}}>
              📬 <strong>Issue #9 {latestIssueLive?"is live":"— coming Sunday"}</strong> — The week "space" stopped being one trade.
            ...
            {feedMode==="newsletter"&&(
              <div style={{animation:"fu 0.2s ease"}}>
                ...
                {[
                  ...
                  {issue:9,date:"07 June 2026",headline:"The week "space" stopped being one trade.",summary:"The week "space" stopped being one trade.",url:LATEST_ISSUE_URL,live:latestIssueLive},    
